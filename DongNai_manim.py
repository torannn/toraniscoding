...
class Bai1(Scene):
    ...
    def construct(self):
        ...
        self.wait()
        tru7 = VGroup(equationA[2].copy().set_color(RED), 
                      leftbracket.copy().next_to(equationA[2], LEFT, buff=0.05), 
                      rightbracket.copy().next_to(equationA[2], RIGHT, buff=0.05)
                      )
        tru7_2 = VGroup(equationA[2].copy().set_color(RED), 
                        leftbracket.copy().next_to(equationA[2], LEFT, buff=0.05), 
                        rightbracket.copy().next_to(equationA[2], RIGHT, buff=0.05)
                        )
